...
class TestAdd(TestCase):
    ...
    def test_large_add(self):
        # TODO: YOUR CODE HERE
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(900, 900, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(900, 900, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "add")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestAbs(TestCase):
    ...
    def test_large_abs(self):
        # TODO: YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(800, 1220, seed=0)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "abs")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestMul(TestCase):
    ...
    def test_medium_mul(self):
        ...
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(50, 74, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
    ...
    def test_larger_mul(self):
        # TODO: YOUR CODE HERE
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(450, 500, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(500, 420, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
    ...
    def test_largest_mul(self):
        # TODO: YOUR CODE HERE
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(970, 780, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(780, 1000, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestPow(TestCase):
    def test_small_pow(self):
        # TODO: YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(2, 2, seed=0)
        is_correct, speed_up = compute([dp_mat, 12], [nc_mat, 12], "pow")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
    ...
    def test_medium_pow(self):
        ...
        is_correct, speed_up = compute([dp_mat, 48], [nc_mat, 48], "pow")
        self.assertTrue(is_correct)
        print_speedup(speed_up)

    def test_large_pow(self):
        # TODO: YOUR CODE HERE
        dp_mat, nc_mat = rand_dp_nc_matrix(260, 260, seed=0)
